                ...
                try {
                    ...
                    if (blog.enableFolderMatching) {
                        ...
                        if (deletedFiles.length > 0) {
                            blogMessage += `🗑️ 删除多余文件: ${deletedFiles.join(', ')}\n`;
                        }
                    }
